  ...
  <AccordionPrimitive.Header className="flex">
    ...
    >
      ...
      <span className="h-4 w-4 shrink-0 transition-transform duration-200">
        <Minus className="h-4 w-4 shrink-0 transition-transform duration-200 group-data-[state=open]:hidden" />
        <Plus className="h-4 w-4 shrink-0 transition-transform duration-200 group-data-[state=closed]:hidden" />
      </span>
    </AccordionPrimitive.Trigger>
